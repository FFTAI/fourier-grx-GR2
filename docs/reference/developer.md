...
| `joint_position`       | 机器人关节的位置信息       | array(float * num_of_joints)   | deg   | 参考机器人关节次序        |
| `joint_velocity`       | 机器人关节的速度信息       | array(float * num_of_joints)   | deg/s | 参考机器人关节次序        |
| `joint_kinetic`        | 机器人关节的力矩信息       | array(float * num_of_joints)   | Nm    | 参考机器人关节次序        |
...
| `position`            | 机器人关节的位置指令        | array(float * num_of_joints) | deg   | 参考机器人关节次序                                        |
| `velocity`            | 机器人关节的速度指令        | array(float * num_of_joints) | deg/s | 参考机器人关节次序                                        |
| `effort`              | 机器人关节的力矩指令        | array(float * num_of_joints) | Nm    | 参考机器人关节次序                                        |
| `current`             | 机器人关节的电流指令        | array(float * num_of_joints) | A     | 参考机器人关节次序                                        |
